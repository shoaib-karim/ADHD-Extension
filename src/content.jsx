import { CheckFlag } from "./Services/checkflag-function";
import { storeOriginalContent } from "./Services/store-original-function";
import { applyEmphasis } from "./Services/apply-emphasis-function";
import { insertFlag } from "./Services/insertflag-function";
import { revertToOriginalContent } from "./Services/revert-function";
import { removeFlag } from "./Services/removeflag-function";
  ...
  if (request.type === "documents") {
    if (request.action === "toggle") {
      ...
      if (request.checked) {
        ...
        storeOriginalContent(originalContents);
        applyEmphasis(originalContents);
        if (!CheckFlag()) insertFlag();
      } else {
        // Toggle is unchecked, revert to original content
        revertToOriginalContent(originalContents);
        removeFlag();
      }
